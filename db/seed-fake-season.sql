...
--
-- Not idempotent by design: it clears the objective set first so re-running
-- gives exactly these 24 rather than accumulating. Submissions on the old
-- objectives are removed with them.
