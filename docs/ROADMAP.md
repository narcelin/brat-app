...
- [x] **Avatars** — a cast of eight original characters, picked at `/me` and
      shown on the roster and in the header. Art is generated by
      `brand/build-avatars.mjs`, so swapping it is a re-run
